...
namespace entropy{
  ...
  ImageSource::ImageSource(const std::string& filename, int subsample, double scale, bool gray):
  ...
  ImageSource::ImageSource(int camera_id, int subsample, double scale, bool gray):
    m_subsample(subsample), 
